...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_COMMENT', 'TASK_DUE_SOON', 'TASK_OVERDUE', 'MEMBER_INVITED', 'MEMBER_JOINED', 'PROJECT_CREATED', 'COMMENT_MENTION', 'COMMENT_REPLY');
...
-- CreateIndex
CREATE UNIQUE INDEX "documents_taskId_key" ON "documents"("taskId");

-- CreateIndex
CREATE UNIQUE INDEX "documents_liveblocksRoomId_key" ON "documents"("liveblocksRoomId");
