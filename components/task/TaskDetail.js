...
/**
 * Full task detail page component.
 * Handles inline editing of all task fields.
 */
            ...
            <div>
              ...
              {canEdit ? (
                <Select
                  ...
                  onValueChange={(val) =>
                    updateTask({ columnId: val === "none" ? null : val })
                  }
                >
                  <SelectTrigger className="h-8 text-sm">
                    <SelectValue />
                        ...
                        {workspaceMembers.map((member) => {
                          ...
                          return (
                            <button
                              key={member.user.id}
                              onClick={() =>
                                handleAssigneeToggle(member.user.id)
                              }
                      ...
                      <form onSubmit={handleCreateLabel} className="space-y-2">
                        ...
                        <div className="flex gap-1">
                          <Button
                            ...
                            disabled={
                              labelCreateLoading || !newLabelName.trim()
                            }
                          >
                            Create
                          </Button>
